...
Et mu raamatutelist, ned mida ma ära annan, on selline:
...
Jõhvi Linnavalitsuse ametnikule Jõhvi elanikust Kaebus
...
Lugupeetud, meie kohalikku omavalitsuse esindaja.
...
Tahaksin märkida, et teenuste kvaliteet muutus halvemaks
Teed on must, parkimiskohad halvas seisundis.
...
Lugupeetud omavalitsuse ametnik, kirjutan teile kaebusega, sest hakkasin märkama, et meie tänavate ja parkide hooldamise tase hakkas halvenema.
...
Juba järgmisel kuul meie asutus tähistab sünnipäevat, sellepärast me plaanime välja anda asutust tutvustav raamat.
...
Tere, meie kallis personaljuht Mart!
...
Loodan, et tulevikus meil on saamasugune seisukord.
...
10 aastat väga hea arv.
Mina töötan sellel asutusel juba 8 aastat ja mulle kõike sobib.
...
Lugupidamisega, Olga --- restoraan Loverte +372---
...
Kokkuvõtteks võin öelda, et töötamine selles asutuses on minu parim otsus, sest seal on väga hea kollektiiv ja töötingimused minu jaoks.

### essay_id = B2IV_002-067
Austatud hr. ---!
Nagu varsti meie kooli ootab sünnipäevapidu, milleks plaanitakse välja anda asutust tutvustav raamat, ma tahaksin kirjutada oma töökogemuse, kollektiivi ja kooli elus osalemise kohta.
...
Lõpuks tähan lisada, et mulle meeldib töötada selles asutuses, sest sõbralik töökeskond aitab töötada kergelt ja rahulikult.
...
Ma ei saa täpselt öelda milline võib asutus olla 10 aasta pärast aga olen kindel, et tulevikus selliste inimestega ja selles tööõhkkonnas me täpselt saavutame edu.
...
See mõte mulle magada et anna!
Oled ju asjatundja selles valdkonnas?
On ju? 
Äkki sa annad nõu, kuidas edasi liikuda?
Soovitad mulle teised platvormikeeled, valmis lahendused.
Või oleks targem tööst lahkuda?
Kuidas sa mõtled?
...
Kirjuta mulle, milline on sinu lahendus selle situatsiooni kohal.
...
Sooviksin, et sa annaksid mulle nõu, kuidas ma saaksin oma ülemust ümberveenda, et ta võttaks veel inimesi tööle?
...
Ausalt rääkides ma mitte kunagi ei mõelnud, et ma kunagi hakkan olümpiaadil osalema, ja et selleks mul tuleb jutustada oma eluvisioonist.
...
Seda olümpiaaditööd kirjutavad paljud õpilased erinevatest koolidest.
...
Ma olen väga haritud ja töökas ja see aitab mul osaleda erinevates projektides.
...
Matemaatika ülesanded on kogu aeg olnud väga rasked, seetõttu kunagi ei ole saanud ma hindeid kõrgemaid kui B ja C.
Aga keemia ülesanded on natuke kergemad ning nad meeldivad mulle rohkem.
...
Elus on olnud ja tuleb ka kindlasti veel ette olukordi, kus eesti keeleta pole mul mitte kusagile minna, kuna tulevik on ootamatuid üllatusi täis. Mis puutub aga minusse, siis olen alati olnud inimene, kellel on olnud omad soovid ja kui ma olen tahtnud neid ellu viia, siis see on mul ka õnnestunud.
...
Minu pere puhkus algas 21. detsembril õhtul kui laste kooli jõulupidu oli läbi pidadud.
...
On üllatavalt raske ülesanne kirjeldada oma loomust, sest see tuntub samaaegselt nii iseloomulikult, et selle on võimatu leida sõnu, ja siiski mõneti ebaselge, kuidas inimene ei kunagi või täiesti ise ennast aru saada.
...
Teiste arvamus on huvitav ja vajalik, aga ees peaks alati seisma enda oma, mis toetub südametunnistusele.
...
Tänapäeval tuleb kindlasti olla meediamaailmas ettevaatlik ja veenduda, ennem kui uskuda.
...
Nagu kirjutas Valdur Mikita oma raamatus "Lingvistika ehk metsa se lingvistika": "Igal eestlasel ühes käes on skype ja teises seenenuga".

### essay_id = C1_2017II_001-038
Eelmisel nädalal olen osalenud globaliseerumiskonverentsil, kus olulisemad teemad olid "Kodumaalt lahkumise põhjused ja võimalikud tagajärjed" ning "Tehnoloogia kiire areng kui kaugsuhtluse võimaldaja".
...
Öeldes tehnoloogia arenguks olen kindel, et see lihtsustab meie elu ja tema kättes on meie tulevik.

### essay_id = C1_2017II_001-068
Täna väga tihti saab kuulda, et toimub globaliseerumine.
...
Kus inimene ei peaks sõidma ära kodumaalt, et töötada heas ettevõttes, teenida head palka ja samas olema oma riigi arendaja, väärtuste ja kultuurikandja.

### essay_id = C1_2017II_001-129
Eelmisel laupäval Tallinnas toimus globaliseerumiskonverents, kus ma osalesin külastajana.
...
Maailmas üha rohkem räägitakse globaliseerumisest, mis tähendab rahvusvahelist, kõikehõlmavat ühinemist.
...
Migreerimisega käib alati kaasa tehnoloogiline areng.
...
Mis aga puutub kaugsuhtlusesse, potensiaalseid ohte võib ennetada õigeaegse kontrolli abil.

### essay_id = C1_2017II_001-167
Eile Tartu Ülikoolis toimus juba teine globaliseerumiskonverents.
...
Eriti seda võiks teha kuskil maakohas||maapiirkonnas.
...
Siis maal ja üldse igas piirkonnas on rohkem noori ja siis on rohkem arengu võimaluseid.
...
Soovitan kõigile võimalusel külastada, kuna see paneb teid veel üks korm mõtlema hakkata ja valida õiget käitumisviisi.
...
Järelduseks võin öelda, et iga inimene vastutab oma elu eest ise ja me kõik oleme ilusa elu väärt.
...
Päästeameti korraldatud teabepäeval oli räägitud õnnetusjuhtumitest.
...
Selleks on vaja alati kontrollida oma tegevusi ja mõelda, mis tagajärgi need võivad tuua.

### essay_id = C1_2017I_001-068
Vaatamata selle, et viimaste aastate jooksul on Eestis tehtud palju ümberkorraldusi siseriiklike asutuste töö korraldamisel tagamaks elanikonna turvalisust ja ohutust, ei vaibu ikka jutud selle kohta, et õnnetusjuhtumite arv ei vähene ja tuleb kiiremas korras midagi ette võtta.
...
Teabepäeva esimesel poolel Päästeameti esindajad püüdsid ära tuua kuulajatele, et õnnetusjuhtumites on suuremas jaos süüdi inimesed ise. eirates lihtsaid ohutusnõudeid.
...
Selle päeva motoks võib välja kuulutada "Inimeste elu on tema endi kätes"
...
Loodame, et edaspidi rohkem inimesi võtavad osa erinevates ühendustes ja vabatahtlikult tulevad sellele, et see tegevus on väga oluline kõikide jaoks.

### essay_id = C1_2018III_003-040
"Vaba tahe" paneb ühiskonda käima
...
Siis nad jääksid selleks, kes nad on - kangelasteks.

### essay_id = C1_2018III_003-047
Kodanikuühenduste konverentsil käsitleti sellised teemad, nagu seltsid ja ühingud kogukonna elu arendajatena ning vabatahtlik kaasamine.
...
Tuleb vaeva nägema selleks, et võimalikult paljud inimesid kuulusid ühendustele ja võtsid osa kas või loodushoiust või päästetöödest - või teise riigielu valdkonnast.
...
Miks mitte lahendada seda muret vabatahlikke abiga?
Imselt oleksid paljud kohalikud lapsed ja muidu raamatuarmastajad huvitatud sedalaadi "hobbist".
Loodetavasti äratab mu kiri laialdasemat huvi meie linnas ja loeksin hea meelega meie linnalehe järgmistest numbritest teie tagasisidet minu mõtete kohta ja ehk ka teie ideeid.

### essay_id = C1_2018II_002-009
Lugupeetud kolleegid, hiljuti ma osalesin digipädevuse seminaril, mis äratas mul mõtteid digipädevuse eeldustest ja riskidest.
...
Aga olgem ettevaatlikumad ja pöörakem rohkem tähelepanu hoiatustele, mis arvutikuvarile ilmuvad, millest riik annab teada või massmeedias teatatakse.
...
Ida-Virimaa on tööstuspiirkond, just see mõjub inimeste tervisele kõige tugevam.
...
Tere, minu lugupeetud kolleegia!
...
Võimalusel käin ka veel kord konverentsil, mis on pühendatud tervisele.

### essay_id = C1_2018IV_002-036
25. oktoobril Tallinnas viidi läbi tervisekonverents, mille käigus käsitleti väga palju erinevaid teemasid, mis puudutasid meie tervist.
...
Loodan, et mul võiks ka võimalus osaleda niisugustes üritustes veel kord.

### essay_id = C1_2018I_001-027
Viimati osalesin ühiskondliku sallivuse ümarlaual, kus arutlesime tänapäeval aina olulisemaks muutuvaid teemasid rahvuste kultuuri ja rahvuslikku identiteedi valdkonnas.
...
Kuid samal ajal ei tohi unustada oma kultuuri ja rahvuslikku identiteedi tähtsust ning peab olema valmis ka seda hoida.

### essay_id = C1_2018I_001-038
Olen osalenud mittu päeva tagasi ühes väga huvitavas ümarlaual, kus käsitleti ühiskondliku sallivust.
...
Soovin mõistlikult suhtuda erinevate riikide rahvustesse, kultuuri ja nende komete vastu.
...
See ongi põhjus miks maailmas sõjad tekkivad.
...
Samuti see võimaldaks kultuuride jagamist inimeste vahel ja nende omamoodi segunemist.